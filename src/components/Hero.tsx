      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-24">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:items-center lg:gap-12">
          <div>
            ...
            <h1 className="mt-6 font-display text-4xl leading-[1.1] text-ink lg:text-[3.4rem]">
              Bring a global lifestyle brand to your city
            </h1>
    ...
    <div className="relative mx-auto aspect-[4/5] w-full max-w-md">
      ...
      <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] shadow-2xl">
        ...
        <div className="relative flex h-full flex-col items-end justify-end p-8 text-paper">
          <span className="font-display text-3xl tracking-tight">mumuso</span>
      ...
      <div className="absolute -bottom-6 left-1/2 w-[65%] -translate-x-1/2 rounded-2xl bg-paper px-6 py-4 shadow-xl lg:w-[85%]">
...
function HeroCTAs({ center = true }: { center?: boolean }) {
  return (
    <div
      className={`flex flex-wrap items-center gap-4 ${center ? "justify-center" : ""}`}
    >
      <Link
        href="/join"
...
function HeroStats({ center = true }: { center?: boolean }) {
  return (
    <div className={`flex flex-wrap gap-8 ${center ? "justify-center" : ""}`}>
